...
<font size=-1>
	...
	<div class="op_foreignu_links">  
		<span><a target="_blank" href="#" click="add_numiid(<?php echo $item->num_iid;?>);"><font color="red">添加到后台</font></a></span>
	</div>
...
?>
<a href="/spider/search?kw=<?php echo urlencode($kw); ?>&page_no=<?php echo $start; ?>&page_size=<?php echo $page_size;?>"><span class="pc"><?php echo $start; ?></span></a>
<?php
	}
}
