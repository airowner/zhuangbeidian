...
<form name="f" action="/spider/search" class="fm"><input  style="width:520px" type="text" name="kw" value="<?php echo $kw; ?>"><input type="hidden" name="page_no" value=""><input type="hidden" name="page_size" value="100"><span class="s_btn_wr"><input type="submit" id="su" value="百度一下" class="s_btn" onmousedown="this.className='s_btn s_btn_h'" onmouseout="this.className='s_btn'"></span></form>
...
<font size=-1>
	...
	<td valign="top" class="op_uni_left"><a target="_blank" href="<?php echo $item->click_url;?>"><img class="op_foreignu_img" alt="图片" src="<?php echo $item->pic_url;?>"></a></td> <td class="op_uni_right">
	...
	<div class="op_foreignu_links">  
		<span><a target="_blank" href="#" click="add_numiid(<?php echo $item->num_iid;?>);">添加到后台</a></span>
	</div>
